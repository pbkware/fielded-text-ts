...
**Fielded Text is ideal for [reading](https://pbkware.github.io/fielded-text-ts/web/Guides/Reading/) and writing database like text data with complex schemas containing multiple [tables](https://pbkware.github.io/fielded-text-ts/web/Guides/Tables/)**.

Note that this library is designed for applications running in a "browser". For "node" applications use [@pbkware/fielded-text-node](https://pbkware.github.io/fielded-text-ts/Node/).
...
- **[Examples](https://pbkware.github.io/fielded-text-ts/Web/Guides/Examples/)** - Small examples that demonstrate various capabilities
